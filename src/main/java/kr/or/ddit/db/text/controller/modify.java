...
public class modify extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		logger.debug("여기는 modify의 doGet부분 입니다.");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("UTF-8");
	      ...
	      logger.debug("board_id - Modify doPost: {}", board_id);
	      logger.debug("userid - Modify doPost: {}", userid);
	      logger.debug("text_title - Modify doPost:: {}", text_title);
	      logger.debug("text_content - Modify doPost: {}", text_content);
	      logger.debug("textid - Modify doPost: {}", text_id);
	      
	      TextVo textVo = new TextVo(text_title, text_content, text_id);
	      
	      textService.updateText(textVo);
	      logger.debug("updateCnt : {}" , textService.updateText(textVo));
